    ...
    public static class ShapeActions {
        ...
        static void InsertShapeValue(IWorkbook workbook)
        {
            ...
            try
            {
                ...
                worksheet.Shapes.AddPicture("Pictures\\chart.png", worksheet.Cells["D5"]);
                // Insert a picture to fit in the specified range.
                worksheet.Shapes.AddPicture("Pictures\\chart.png", worksheet.Range["B2"]);
                ...
                worksheet.Shapes.AddPicture("Pictures\\chart.png", 0, 0);
        ...
        static void ModifyShapeValue(IWorkbook workbook)
        {
            ...
            try
            {
                ...
                Picture pic = worksheet.Shapes.AddPicture("Pictures\\chart.png", worksheet.Cells["A1"]);
                worksheet.Shapes.AddPicture("Pictures\\candles.png", worksheet.Cells["D5"]);
