...
#End Region
        ...
        Private Shared Sub InsertShapeValue(ByVal workbook As IWorkbook)
            '			#Region "#insertshape"
            Dim imageStream As Stream = System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("SpreadsheetControl_WPF_API_Part02.x-spreadsheet.png")
            ...
            Try
                ...
                worksheet.Shapes.AddPicture("x-docserver.png", worksheet.Cells("D5"))
                ' Insert a picture to fit in the specified range.
                worksheet.Shapes.AddPicture("x-docserver.png", worksheet.Range("B2"))
                ...
                worksheet.Shapes.AddPicture("x-docserver.png", 0, 0)
        ...
        Private Shared Sub ModifyShapeValue(ByVal workbook As IWorkbook)
            ...
            Try
                ...
                Dim pic As Picture = worksheet.Shapes.AddPicture("x-docserver.png", worksheet.Cells("A1"))
                worksheet.Shapes.AddPicture("x-spreadsheet.png", worksheet.Cells("D5"))
